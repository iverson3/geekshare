...
namespace Proxies\__CG__\Home\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Home\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'password', '' . "\0" . 'Home\\UserBundle\\Entity\\User' . "\0" . 'role', 'points', 'isopen', 'logintime', 'status');
        }
    ...
    public function getIsopen()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsopen', array());
    ...
    public function setLogintime($logintime)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLogintime', array($logintime));
    ...
    public function getLogintime()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLogintime', array());
